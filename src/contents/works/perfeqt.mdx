...
year: "2023"
deliverables: "Product Design, UX Research, Mobile UI Design, UI Motion, Prototyping"
...
## Overview
I was in charge of the whole design process for Perfeqt. My role covered everything from the initial benchmarking, designing, handing over to developers, and maintaining the app’s user experience. So far, Perfeqt's doing pretty well with over 12K people signed up and 11K product subscriptions.

<img 
  src="/images/15 biomarks evaluated by Perfeqt.png"
  alt="15 biomarks evaluated by Perfeqt"
  style={{ width: '100%', maxHeight: '600px' }} 
/>
...
## Conclusion
Perfeqt has grown 5 times since 2021, driven by strong momentum in the at-home testing market, solid marketing effort, and effective product adoption with user centered constant iterations.
